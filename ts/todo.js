...
(function (todomvc) {
    ...
    function transverse(name, myObject, func) {
        var type = typeof (myObject);
        var msg = '' + name + ' is ' + type;
        if (myObject instanceof Array) {
            msg += ' and one instance of Array ' + 'class with length ' + myObject.length;
        }
        console.log(msg);
    ...
    function logObjProps(name, myObject) {
        transverse(name, myObject, console.log);
    }
    todomvc.logObjProps = logObjProps;
    ...
    var App = (function () {
        ...
        function App(Y, templateEngine) {
            ...
            if (footerInfo) {
                ...
                throw new Error('Aplicação depende de BODY_TEMPLATE ' + 'estar renderizado no DOM.');
            }
