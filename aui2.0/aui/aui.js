...
**/
    add: function(name, fn, version, details) {
    	...
    	if (typeof (details) == 'undefined' || 
    			typeof (details.requires) == 'undefined') {
    		requiresArray = ['nothing'];
    	} else {
    		if (typeof (details.requires) != 'undefined') {
    			requiresArray = details.requires;
    		}
    	}
    	console.log(name + ' requires = ' + requiresArray.join(' '));
        details = details || {};
        var env = YUI.Env,
            mod = {
                name: name,
